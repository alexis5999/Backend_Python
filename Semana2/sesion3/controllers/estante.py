...
class EstanteController(Resorce):
    ...
    def get(self):
        ...
        for estante in estantes:
            ...
            for libro in estante.libros:
                ...
                libros.append(libros.mostrar_json())
    ...
    def post(self):
        ...
        try:
            ...
            return {
            'ok':True,
            'message': 'Se guardo existosamente el estante'
            'content': estante.mostrar_json()  
        }
        except:
            return{
                'ok': False
                'message':'No se pudo guardar el estante en la base de datos'
            }, 500 
